          ...
          next: (response) => {
            if (response.ok && response.data) {
              ...
              this.evento = {
                ...
                restricciones: eventoData.restricciones || '',
                politicasDevolucion: eventoData.politicasDevolucion || '',
                menoresDeEdadPermitidos: eventoData.menoresDeEdadPermitidos || false
              };
